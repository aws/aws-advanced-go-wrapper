...
func TestOktaCredentialsProviderGetSamlAssertion(t *testing.T) {
	...
	getOktaTestHttpClientFunc := func(timeoutMs int, sslInsecure bool, jar http.CookieJar) federated_auth.HttpClient {
		return mockHttp
	}
...
func TestOktaAuthPluginHttpErrorOnSamlRequest(t *testing.T) {
	...
	queryParams.Set(federated_auth.ONE_TIME_TOKEN, expectedSessionToken)
