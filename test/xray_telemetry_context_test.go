...
func TestNewXRayContext(t *testing.T) {
	...
	xrayCtx0, resultCtx0 := telemetry.NewXRayTelemetryContext("test 0", telemetry.NESTED, nil)
	xrayCtx1, resultCtx1 := telemetry.NewXRayTelemetryContext("test 1", telemetry.NESTED, resultCtx0)
	xrayCtx2, resultCtx2 := telemetry.NewXRayTelemetryContext("test 2", telemetry.TOP_LEVEL, resultCtx0)
...
func TestXRayClone(t *testing.T) {
	...
	xrayCtx, _ := telemetry.NewXRayTelemetryContext("test 0", telemetry.NESTED, nil)
