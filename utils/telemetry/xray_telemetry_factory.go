...
func (X XRayTelemetryFactory) OpenTelemetryContext(name string, traceLevel TelemetryTraceLevel, ctx context.Context) (TelemetryContext, context.Context) {
	return NewXRayTelemetryContext(name, traceLevel, ctx)
}

func (X XRayTelemetryFactory) PostCopy(telemetryContext TelemetryContext, traceLevel TelemetryTraceLevel) error {
...
func (X XRayTelemetryFactory) CreateCounter(name string) (TelemetryCounter, error) {
...
func (X XRayTelemetryFactory) CreateGauge(name string) (TelemetryGauge, error) {
