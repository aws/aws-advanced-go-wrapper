...
func (o *OktaAuthPlugin) connectInternal(
	...
	port := iam.GetIamPort(property_util.GetVerifiedWrapperPropertyValue[int](props, property_util.IAM_DEFAULT_PORT), *hostInfo, o.pluginService.GetDialect().GetDefaultPort())
	...
	if err != nil && o.pluginService.IsLoginError(err) {
		err = o.updateAuthenticationToken(props, region, cacheKey, host, port)
		if err != nil {
			return nil, err
		}
