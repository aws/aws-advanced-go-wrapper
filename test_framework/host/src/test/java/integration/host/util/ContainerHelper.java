...
public class ContainerHelper {
  ...
  public void debugTest(GenericContainer<?> container, String testFolder, TestEnvironmentConfig config)
    ...
    Long exitCode;
    if (filter != null) {
      exitCode = execInContainer(container, consumer, "dlv", "test", "--headless", "--listen=:5005", "--api-version=2",
              "--accept-multiclient", "./test_framework/container/tests...",  "--", "-test.run", filter);

    } else {
      // Debug all tests located in aws-advanced-go-wrapper/test_framework/container.
      exitCode = exitCode = execInContainer(container, consumer, "dlv", "test", "--headless", "--listen=:5005",
  ...
  public GenericContainer<?> createTestContainer(
    ...
    return container
        ...
        .withFileSystemBind("../../container", "/app/container", BindMode.READ_ONLY)
        .withFileSystemBind("../../driver", "/app/driver", BindMode.READ_ONLY)
        .withFileSystemBind("../../driver_infrastructure", "/app/driver_infrastructure", BindMode.READ_ONLY)
        .withFileSystemBind("../../error_util", "/app/error_util", BindMode.READ_ONLY)
        .withFileSystemBind("../../host_info_util", "/app/host_info_util", BindMode.READ_ONLY)
        .withFileSystemBind("../../plugin_helpers", "/app/plugin_helpers", BindMode.READ_ONLY)
        .withFileSystemBind("../../plugins", "/app/plugins", BindMode.READ_ONLY)
        .withFileSystemBind("../../property_util", "/app/property_util", BindMode.READ_ONLY)
        .withFileSystemBind("../../region_util", "/app/region_util", BindMode.READ_ONLY)
        .withFileSystemBind("../../resources", "/app/resources", BindMode.READ_ONLY)
        .withFileSystemBind("../../utils", "/app/utils", BindMode.READ_ONLY)
        .withFileSystemBind("../../implementations_test.go", "/app/implementations_test.go", BindMode.READ_ONLY)
        .withFileSystemBind("../../go.sum", "/app/go.sum", BindMode.READ_ONLY)
        .withFileSystemBind("../../go.mod", "/app/go.mod", BindMode.READ_ONLY)
        .withFileSystemBind("../../test_framework/host/src/test/resources/global-bundle.pem", "/app/global-bundle.pem", BindMode.READ_ONLY)
        .withFileSystemBind("../../test_framework/container", "/app/test_framework/container", BindMode.READ_WRITE)
