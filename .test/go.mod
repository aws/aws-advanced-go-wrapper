...
require (
	...
	github.com/aws/aws-advanced-go-wrapper/auth-helpers v1.0.1-rc
	github.com/aws/aws-advanced-go-wrapper/aws-secrets-manager v1.0.1-rc
	github.com/aws/aws-advanced-go-wrapper/awssql v1.1.0-rc
	github.com/aws/aws-advanced-go-wrapper/federated-auth v1.0.1-rc
	github.com/aws/aws-advanced-go-wrapper/iam v1.0.1-rc
	github.com/aws/aws-advanced-go-wrapper/mysql-driver v1.0.1-rc
	github.com/aws/aws-advanced-go-wrapper/okta v1.0.1-rc
	github.com/aws/aws-advanced-go-wrapper/otlp v1.0.1-rc
	github.com/aws/aws-advanced-go-wrapper/pgx-driver v1.0.1-rc
	github.com/aws/aws-advanced-go-wrapper/xray v1.0.1-rc
