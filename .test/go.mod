...
require (
	...
	github.com/aws/aws-advanced-go-wrapper/aws-secrets-manager v1.0.3
	github.com/aws/aws-advanced-go-wrapper/awssql v1.2.0
	github.com/aws/aws-advanced-go-wrapper/custom-endpoint v1.0.0
	github.com/aws/aws-advanced-go-wrapper/federated-auth v1.0.3
	github.com/aws/aws-advanced-go-wrapper/iam v1.0.3
	github.com/aws/aws-advanced-go-wrapper/mysql-driver v1.0.3
	github.com/aws/aws-advanced-go-wrapper/okta v1.0.3
	github.com/aws/aws-advanced-go-wrapper/otlp v1.0.3
	github.com/aws/aws-advanced-go-wrapper/pgx-driver v1.0.3
	github.com/aws/aws-advanced-go-wrapper/xray v1.0.3
...
require (
	...
	github.com/aws/aws-sdk-go-v2/internal/configsources v1.4.11 // indirect; indirectg
