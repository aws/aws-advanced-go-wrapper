...
// Source: github.com/aws/aws-advanced-go-wrapper/awssql/v2/driver_infrastructure (interfaces: HostListProviderService,PluginService,PluginManager,CanReleaseResources)
...
import (
	...
	utils "github.com/aws/aws-advanced-go-wrapper/awssql/v2/utils"
...
// IsDialectConfirmed mocks base method.
func (m *MockPluginService) IsDialectConfirmed() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsDialectConfirmed")
	ret0, _ := ret[0].(bool)
	return ret0
}

// IsDialectConfirmed indicates an expected call of IsDialectConfirmed.
func (mr *MockPluginServiceMockRecorder) IsDialectConfirmed() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsDialectConfirmed", reflect.TypeOf((*MockPluginService)(nil).IsDialectConfirmed))
}
...
func (m *MockPluginManager) Init(arg0 []driver_infrastructure.ConnectionPlugin) error {
	m.ctrl.T.Helper()
...
func (mr *MockPluginManagerMockRecorder) Init(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Init", reflect.TypeOf((*MockPluginManager)(nil).Init), arg0)
}
