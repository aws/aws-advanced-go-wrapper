...
func (m *MockPluginManager) Execute(name string, methodFunc driver_infrastructure.ExecuteFunc, methodArgs ...any) (any, any, bool, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{name, methodFunc}
...
func (mr *MockPluginManagerMockRecorder) Execute(name, methodFunc interface{}, methodArgs ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{name, methodFunc}, methodArgs...)
