...
* Failover did not trigger when a connection was closed while a call was in flight, and the transaction state was reported incorrectly afterwards ([PR #582](https://github.com/aws/aws-advanced-go-wrapper/pull/582)).
