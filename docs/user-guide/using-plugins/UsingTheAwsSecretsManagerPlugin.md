...
| `secretsManagerSecretPasswordProperty` | String  |                            No                            | Set this value to be the key in the JSON secret that contains the password for database connection.                                                                                                                              | `db_user`               | `username`    |
| `secretsManagerExpirationSec`          | String  |                            No                            | This property sets the time in seconds that secrets are cached before it is re-fetched.                                                                                                                                          | `db_pass`               | `password`    |
