...
2. [github.com/aws/aws-advanced-go-wrapper/iam](../../../iam) to be a dependency in the project
    ...
    - The module registers the plugin when it is imported, so the application must import it for its side effects. Without the import, `iam` is an unknown plugin code.
