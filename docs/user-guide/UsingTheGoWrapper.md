...
|-----------------------|----------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|
| `plugins`             | `string` | No       | Comma separated list of connection plugin codes.                                                                                                            | `auroraConnectionTracker,failover,efm` |
...
The default value for `plugins` is `auroraConnectionTracker,failover,efm`. These plugins are enabled by default. To read more about these
...
|---------------------------------------------------------------------------------------------|----------------------|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|
| [Aurora Connection Tracker Plugin](./UsingTheAuroraConnectionTrackerPlugin.md)              | `auroraConnectionTracker` | Aurora             | Tracks opened connections and closes connections affected by changes to the cluster topology. This plugin is enabled by default.                                                                                | None                                                                                                                           |
| [Aurora Initial Connection Strategy Plugin](./using-plugins/UsingTheAuroraInitialConnectionStrategyPlugin.md) | `initialConnection` | Aurora       | Selects an initial reader using a configured strategy and improves connection reliability while cluster endpoint DNS records are updating.                                                                       | None                                                                                                                           |
| [Failover Connection Plugin](./using-plugins/UsingTheFailoverPlugin.md)                     | `failover`           | Aurora                 | Enables the failover functionality supported by Amazon Aurora clusters. On a writer cluster endpoint it also prevents opening a connection to an old writer instance due to stale DNS after a failover event. On a custom domain or IP address that protection needs the [Aurora Initial Connection Strategy Plugin](./using-plugins/UsingTheAuroraInitialConnectionStrategyPlugin.md#endpoint-types). This plugin is enabled by default. | None                                                                                                                           |
...
| [GDB Read Write Splitting Plugin](./using-plugins/UsingTheGdbReadWriteSplittingPlugin.md)          | `gdbReadWriteSplitting` | Aurora                 | Enables read write splitting functionality where users can switch between reader and writer endpoints. Allows to specify home region and constrain new connections to this region.                                                                                           |None                                                                                                                           |
...
| [Custom Endpoint Plugin](./using-plugins/UsingTheCustomEndpointPlugin.md)                   | `customEndpoint`     | Aurora                 | Ensures that connections made through an RDS custom endpoint use instances included in that endpoint.                                                                                                             | See the Custom Endpoint Plugin [dependencies](./using-plugins/UsingTheCustomEndpointPlugin.md#dependencies)                   |
| [Developer Plugin](./using-plugins/UsingTheDeveloperPlugin.md)                              | `dev`                | Any database           | Injects errors into connection and database method calls for testing. This plugin is not intended for production use.                                                                                             | None                                                                                                                           |
| Connect Time Plugin                                                                         | `connectTime`        | Any database           | Measures and logs the time spent opening regular and forced connections. Intended for debugging and performance measurement.                                                                                      | None                                                                                                                           |
| Execution Time Plugin                                                                       | `executionTime`      | Any database           | Measures and logs the time spent executing database methods. Intended for debugging and performance measurement.                                                                                                  | None                                                                                                                           |
