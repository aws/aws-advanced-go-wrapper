...
| `databaseDialect`            | `string` | No                                                                               | A unique identifier for the supported database dialect. One of `aurora-mysql`, `rds-mysql`, `mysql`, `aurora-pg`, `rds-pg`, or `pg`.                                                                                                                                                                                                                                                                                               | If not provided, determines value from DSN.                                                                                                                              | `latest`          |
