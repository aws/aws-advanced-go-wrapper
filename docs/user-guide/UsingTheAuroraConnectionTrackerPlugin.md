...
This plugin is enabled by default. It can also be explicitly included by adding the plugin code `auroraConnectionTracker` to the [`plugins`](./UsingTheGoWrapper.md#connection-plugin-manager-parameters) value.
